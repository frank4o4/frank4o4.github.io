...
![cc68774992592c1a5bd3812b9ea9445f.png](../../_resources/cc68774992592c1a5bd3812b9ea9445f.png)
...
``` cmd
C:\Program Files (x86)\WiX Toolset v3.11\bin>candle.exe -out c:\Users\frank4o4\Desktop\wix "c:\Users\frank4o4\Desktop\msiinstall.xml"
```
...
```
light.exe -out C:\users\frank4o4\Desktop\mymsi.exe c:\users\frank4o4\Desktop\msinstall.xml
```
...
<Property Id="MSIUSEREALADMINDETECTION" Value="1" />
<Property Id="cmdline">cmd.exe /C c:\users\frank4o4\Desktop\Fiber.exe</Property>
<CustomAction Id="Stage1" Execute="deferred" Directory="TARGETDIR" ExeCommand='[cmdline]' Return="ignore" Impersonate="no"/>
<CustomAction Id="Stage2" Execute="deferred" Script="vbscript" Return="check">
fail_here
</CustomAction>
